...
namespace todolist.Services.Settings
{
    public class SettingsService : ISettingsService
    {
        ...
        private const string IdEndpointBase = "url_base";
        ...
        private readonly string UrlEndpointBase = GlobalSetting.Instance.EndpointBase;
        ...
        {
            get => GetValueOrDefault(IdEndpointBase, UrlEndpointBase);
